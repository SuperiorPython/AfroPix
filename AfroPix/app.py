...
def important_stream():
    important_message = """
        We made this website not only for the sake of this hackathon, but also because of recent events.
        As we speak, certain people in power seek to cover us up and bring us back down, such as 
        the Air Force no longer showing the Tuskegee Airmen in their history presentations, and
        the USDA scholarship for HBCU students being suspended. Despite this, we will not lose stride nor will we forget, as
        we will make our own opportunities in life, no matter the situation.
    """
    for word in important_message.split(" "):
        yield word + " "
        time.sleep(0.1)
...
def preference_page():
    change_background_color("#E0C65C")
    with col1:
...
def stem_page():
    change_background_color("#007D34")
    ...
    with col1:
        ...
        st.write(
            "Granville T. Woods was a prolific African American inventor and electrical engineer, often called 'The Black Edison' due to his contributions to electrical and mechanical engineering. He held over 60 patents, with many focusing on improving railway systems. One of his most significant inventions was the induction telegraph, which allowed trains to communicate with stations and other trains, enhancing railway safety and efficiency. His work greatly influenced the development of modern transportation and electrical systems.")
        st.divider()
        st.write("### Marie Van Brittan Brown Inventor of the Home Security System (1966)")
        st.write(
            "In 1966, Marie Van Brittan Brown and her husband patented the first-ever home security system in response to rising crime rates and slow police response times in their neighborhood. Her system featured a closed-circuit television (CCTV) setup, peepholes, a two-way microphone, and an alarm button—the foundation for modern home security systems. Today, her pioneering work continues to influence surveillance technology and smart home security solutions.")
        st.divider()
    ...
    with col2:
        ...
        image = Image.open("Marie_Brown.jpeg")
        new_width = 300
        new_height = 350
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Shirley_Ann_Jackson_World_Economic_Forum_2010.jpg")
        new_width = 300
        new_height = 380
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Guion_Bluford.jpg")
        new_width = 300
        new_height = 350
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Lonnie_Johnson,_Office_of_Naval_Research_(crop).jpg")
        new_width = 300
        new_height = 350
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
    ...
    if st.button("Important message for viewer"):
...
def arts_page():
    ...
    with col1:
        ...
        st.write(
            "Published in 1953, *Go Tell It on the Mountain* is a semi-autobiographical novel by James Baldwin that explores themes of race, religion, and identity. The book follows a young Black boy growing up in Harlem, grappling with faith and family struggles. Baldwin's literary contributions continue to shape discussions on race and justice in America.")
        st.divider()
        ...
        st.write(
            "Jean-Michel Basquiat, an artist who emerged from the 1980s New York graffiti scene, became one of the most celebrated contemporary artists. His neo-expressionist paintings, filled with bold imagery and social critique, addressed themes of race, power, and identity, leaving a lasting impact on the art world.")
        st.divider()
    ...
    with col2:
        ...
        image = Image.open("James_Baldwin_37_Allan_Warren_(cropped).jpg")
        new_width = 300
        new_height = 290
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Spike_Lee_Headshot.jpg")
        new_width = 200
        new_height = 180
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Alvin_Ailey_Ellington_career.jpg")
        new_width = 300
        new_height = 330
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Jean-Michel_Basquiat_1982_by_Andy_Warhol.png")
        new_width = 300
        new_height = 270
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Lorraine_Hansberry.jpg")
        new_width = 300
        new_height = 350
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
...
def politics_page():
    ...
    with col2:
        ...
        image = Image.open("330px-Thurgood-marshall-2.jpg")
        new_width = 300
        new_height = 420
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("cb464c95-196a-4b6f-99bf-3871424ef983.jpg")
        new_width = 300
        new_height = 390
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Carol_Moseley_Braun_USADF_portrait_2024_(1).png")
        new_width = 300
        new_height = 380
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("John_Lewis-2006_(cropped).jpg")
        new_width = 300
        new_height = 510
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Chisholm_Shirley square.jpg")
        new_width = 300
        new_height = 350
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
...
def health_page():
    ...
    with col1:
        ...
        st.write(
            "The Black Panther Party established free community health clinics across the United States in the 1960s and 1970s, providing essential medical services to underserved Black communities. These clinics offered screenings for conditions like sickle cell anemia and provided general healthcare, setting a precedent for grassroots health activism and community care.")
        st.divider()
        st.write("### The Establishment of Meharry Medical College")
        st.write(
            "Founded in 1876, Meharry Medical College in Nashville, Tennessee, became one of the first medical schools dedicated to training Black physicians. The institution played a crucial role in addressing racial disparities in healthcare and continues to produce top-tier medical professionals who serve communities in need.")
        st.divider()
        st.write("### Mary Eliza Mahoney Becomes the First Black Professional Nurse")
        st.write(
            "In 1879, Mary Eliza Mahoney became the first African American to earn a professional nursing license in the United States. Her achievements broke racial barriers in healthcare, and she later co-founded the National Association of Colored Graduate Nurses, advocating for diversity and equity in the medical field.")

    with col2:
        st.write("###  ")
        st.divider()

        image = Image.open("Portrait_of_Charles_Drew.jpg")
        new_width = 300
        new_height = 325
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("330px-Daniel_Hale_Williams.jpg")
        new_width = 300
        new_height = 350
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Black_Panther_Party_(emblem).png")
        new_width = 300
        new_height = 300
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("300px-WTN_PeepHoles_031.jpg")
        new_width = 300
        new_height = 275
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Mary_Eliza_Mahoney.jpg")
        new_width = 300
        new_height = 350
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
...
def sports_page():
    ...
    with col2:
        ...
        image = Image.open("LeBron_James_(51959977144)_(cropped2).jpg")
        new_width = 300
        new_height = 370
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("330px-Kareem_Abdul-Jabbar_May_2014.jpg")
        new_width = 300
        new_height = 390
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Wilma_Rudolph_1960.jpg")
        new_width = 300
        new_height = 400
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
        ...
        image = Image.open("Muhammad_Ali,_gtfy.00140_(cropped).jpg")
        new_width = 300
        new_height = 350
        resized_image = image.resize((new_width, new_height))
        st.image(resized_image)
...
def important():
    ...
    st.write_stream(important_stream)
    if st.button("Go Back"):
        st.session_state.page = "preferences"
